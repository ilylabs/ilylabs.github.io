...
Our latest paper introduces **VELUM** — a novel composite membrane architecture specifically engineered for **minimal gas leakage** while maintaining ultra-low areal mass. This work complements the lab's ongoing research on lightweight rigid structures for indoor aerostats (see the [3D Printed Aerostats](/projects/Polyproc-3dprintedballoons/) project), now extending to the flexible envelope itself.
...
This work is a direct output of the [Flying Whales](https://www.flying-whales.com) collaboration and positions ilylabs at the intersection of composite manufacturing and lighter-than-air vehicle design.
{: style="text-align: justify;"}
