...
<div align="center">
<img src="/assets/img/extrusion-rate/fig1-specimens.png" alt="Schematic illustration of the samples produced using a 1 mm nozzle: (a) Extrudate fabrication, (b) Printed single-extrudate-thick box geometry, (c) Type IV tensile samples extracted at 0° direction." width="50%">
</div>
...
<img src="/assets/img/extrusion-rate/fig4-dsc-thermograms.png" alt="DSC thermograms showing crystallinity increase. Notice how the melting peak grows dramatically for high-rate extrudates (EXT-E24) compared to low-rate (EXT-E6), indicating fourfold crystallinity increase." width="80%">
...
<img src="/assets/img/extrusion-rate/fig5-surface-roughness.png" alt="Surface roughness of extrudates showing degradation at high extrusion rates. The 3D surface maps and Ra values clearly show EXT-E24 has significantly rougher texture than EXT-E6 and EXT-E12." width="80%">
