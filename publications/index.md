...
To subscribe to new publications via RSS, use the [Bibbase RSS feed](https://bibbase.org/rss?bib=https%3A%2F%2Fapi.zotero.org%2Fgroups%2F4390760%2Fitems%3Fkey%3DhIghhwsB7LyrUtDFrpIyKFqY%26format%3Dbibtex%26limit%3D100). Note: the site's main RSS feed (`feed.xml`) contains blog posts only — publications are loaded dynamically from Zotero and are not included in it.
